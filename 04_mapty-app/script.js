...
class App {
  ...
  _moveToPopup(e) {
    const workoutEl = e.target.closest('.workout'); //we are using event delegation so click on the sibling elements will all store the parent element.
  ...
  reset() {
    ...
    location.reload(); //reload the page after removing workout
  }
}
